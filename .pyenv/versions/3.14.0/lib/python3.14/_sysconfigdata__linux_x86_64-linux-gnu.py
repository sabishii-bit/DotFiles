...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/home/lain/.pyenv/versions/3.14.0/bin',
    'BINLIBDEST': '/home/lain/.pyenv/versions/3.14.0/lib/python3.14',
    'BLDLIBRARY': '-L. -lpython3.14',
    'BLDSHARED': 'gcc -shared -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CONFIGURE_CPPFLAGS': '-I/home/lain/.pyenv/versions/3.14.0/include',
    'CONFIGURE_LDFLAGS': '-L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--prefix=/home/lain/.pyenv/versions/3.14.0' '--enable-shared' '--libdir=/home/lain/.pyenv/versions/3.14.0/lib' 'LDFLAGS=-L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib' 'LIBS=-L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib' 'CPPFLAGS=-I/home/lain/.pyenv/versions/3.14.0/include'",
    'CONFINCLUDEDIR': '/home/lain/.pyenv/versions/3.14.0/include',
    'CONFINCLUDEPY': '/home/lain/.pyenv/versions/3.14.0/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/tmp/python-build.20251130163601.26622/Python-3.14.0/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/tmp/python-build.20251130163601.26622/Python-3.14.0/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.14 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include -I/home/lain/.pyenv/versions/3.14.0/include -I/home/lain/.pyenv/versions/3.14.0/include',
    'CXX': 'g++',
    'DESTDIRS': '/home/lain/.pyenv/versions/3.14.0 /home/lain/.pyenv/versions/3.14.0/lib /home/lain/.pyenv/versions/3.14.0/lib/python3.14 /home/lain/.pyenv/versions/3.14.0/lib/python3.14/lib-dynload',
    'DESTLIB': '/home/lain/.pyenv/versions/3.14.0/lib/python3.14',
    'DESTPATH': '',
    'DESTSHARED': '/home/lain/.pyenv/versions/3.14.0/lib/python3.14/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/home/lain/.pyenv/versions/3.14.0/bin/python3.14',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/home/lain/.pyenv/versions/3.14.0/include /home/lain/.pyenv/versions/3.14.0/include /home/lain/.pyenv/versions/3.14.0/include/python3.14 /home/lain/.pyenv/versions/3.14.0/include/python3.14',
    'INCLUDEDIR': '/home/lain/.pyenv/versions/3.14.0/include',
    'INCLUDEPY': '/home/lain/.pyenv/versions/3.14.0/include/python3.14',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'g++ -shared -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'LDFLAGS': '-L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.14.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -shared -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'LDVERSION': '3.14',
    'LIBC': '',
    'LIBDEST': '/home/lain/.pyenv/versions/3.14.0/lib/python3.14',
    'LIBDIR': '/home/lain/.pyenv/versions/3.14.0/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/lain/.pyenv/versions/3.14.0/include -I/home/lain/.pyenv/versions/3.14.0/include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/home/lain/.pyenv/versions/3.14.0/lib/pkgconfig',
    'LIBPL': '/home/lain/.pyenv/versions/3.14.0/lib/python3.14/config-3.14-x86_64-linux-gnu',
    'LIBPYTHON': '',
    'LIBRARY': 'libpython3.14.a',
    'LIBRARY_DEPS': 'libpython3.14.a libpython3.14.so libpython3.so',
    'LIBRARY_OBJS': '\\',
    'LIBRARY_OBJS_OMIT_FROZEN': '\\',
    'LIBS': '-ldl -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': 'gcc',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/home/lain/.pyenv/versions/3.14.0/lib/python3.14',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/home/lain/.pyenv/versions/3.14.0/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/lain/.pyenv/versions/3.14.0/include -I/home/lain/.pyenv/versions/3.14.0/include -fPIC -DPy_BUILD_CORE_BUILTIN',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/lain/.pyenv/versions/3.14.0/include -I/home/lain/.pyenv/versions/3.14.0/include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'PY_CPPFLAGS': '-I. -I./Include -I/home/lain/.pyenv/versions/3.14.0/include -I/home/lain/.pyenv/versions/3.14.0/include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 1,
    'PY_LDFLAGS': '-L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/home/lain/.pyenv/versions/3.14.0/include -I/home/lain/.pyenv/versions/3.14.0/include -fPIC',
    'PY_SUPPORT_TIER': 1,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/python-build.20251130163601.26622/Python-3.14.0',
    'SCRIPTDIR': '/home/lain/.pyenv/versions/3.14.0/lib',
    ...
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl -L/home/lain/.pyenv/versions/3.14.0/lib -Wl,-rpath,/home/lain/.pyenv/versions/3.14.0/lib',
    'SHLIB_SUFFIX': '.so',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/python-build.20251130163601.26622/Python-3.14.0 ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/python-build.20251130163601.26622/Python-3.14.0 ./python -E -m test',
    ...
    'abs_builddir': '/tmp/python-build.20251130163601.26622/Python-3.14.0',
    'abs_srcdir': '/tmp/python-build.20251130163601.26622/Python-3.14.0',
    'datarootdir': '/home/lain/.pyenv/versions/3.14.0/share',
    'exec_prefix': '/home/lain/.pyenv/versions/3.14.0',
    'host_exec_prefix': '/home/lain/.pyenv/versions/3.14.0',
    'host_prefix': '/home/lain/.pyenv/versions/3.14.0',
    'prefix': '/home/lain/.pyenv/versions/3.14.0',
    'srcdir': '.',
}
